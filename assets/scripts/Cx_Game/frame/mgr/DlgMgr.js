...
var QyDlgManager = class QyDlgManager{
    ...
    constructor() {
        ...
        {
            "win":{"start":"DlgGameEnd","DlgGameEnd":"GameRoom"},
            "wx":{"start":"DlgShowResult","DlgGameEnd":"DlgShowResult","DlgShowResult":"DlgFullAdv","DlgFullAdv":"GameRoom"},
            "vivo":{"start":"DlgShowResultAnim","DlgShowResultAnim":"DlgGameEnd_vivo","DlgGameEnd_vivo":"DlgLevelSelect", "DlgLevelSelect":"DlgActorSelect","DlgActorSelect":"DlgShowVs"},
            "oppo":{},
            "qq":{},
        }
        this._dirConfig_win =  this._dirConfig_lose;

        this._dirConfig_break = 
        {
            "win":{"start":"DlgLevelSelect", "DlgLevelSelect":"DlgActorSelect","DlgActorSelect":"DlgShowVs"},
            "wx":{"start":"DlgLevelSelect", "DlgLevelSelect":"DlgActorSelect","DlgActorSelect":"DlgShowVs"},
            "vivo":{"start":"DlgLevelSelect", "DlgLevelSelect":"DlgActorSelect","DlgActorSelect":"DlgShowVs"},
            "oppo":{},
            "qq":{},
        }
    }
    init(_gameRoom) {
        ...
        self._dirConfig_win.wx.DlgShowResultAnim = "DlgExitAdv";
        self._dirConfig_lose.wx.DlgShowResultAnim = "DlgExitAdv";
    ...
    autoGameEndDlg(type) {
        ...
        console.log("show dlg "+name);
        this.showDlg(name);
    }
    showTips(msg,prefab) {
        if(!msg || msg== "") return;
        prefab = prefab || this.getPrefab("Tips");
    ...
    dlgClosed(name,info) {
        ...
        if(nextName == "GameRoom") {
            let order = "initGame";
            if(cx_DyDataMgr.getRoundInfo("joinType") === 1) {
                order = "startGame";
            }
...
/*     showDlgGameEnd() {
        let name = "DlgGameEnd";
        let node = cx_UIMgr.getPreNode(name);
        //nodejs.init(mManager,closeCb);
        this._addNode.addChild(node);
        this.showTips("show dlggameend");
        return node
    } */
    /**
