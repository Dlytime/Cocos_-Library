...
vec3 hsv2rgb(vec3 c)
{
    ...
    return c.z * mix(K.xxx, clamp(p - K.xxx, 0.0, 1.0), c.y);
            ...
            void main () {
                ...
                o.a = 1.0;
                //vec3 asdfasdf = rgb2hsv(o.xyz);
                //asdfasdf.b = 1.0;
                //vec3 rgbbbb = hsv2rgb(asdfasdf);
                //gl_FragColor = vec4(rgbbbb.x, rgbbbb.y, rgbbbb.z, 1);

                gl_FragColor = o;

                //gl_FragColor = vec4(63/255, 170/255, 0.8, 1);
            }
            `
    },
    Ice: {
