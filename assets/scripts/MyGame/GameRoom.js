...
/*             if(G_PlatHelper.isWXPlatform())
            {
                cx_QyDlgMgr.showDlg("DlgFullAdv_dc");
            } */
        }
    },
    _initGame:function() {
...
/*                         let nodejs = cx_QyDlgMgr.getNodeJs("DlgRoomAdv");
    ...
    _showLoading:function() {
        let nodejs = cx_UIMgr.getPreInstance(this.dlgLoadingPre);
    ...
    _showActorSelect:function() {
        let nodejs = cx_QyDlgMgr.showDlg("DlgActorSelect",this,null);
    },
    share:function() {
        cx_QyMgr.share();
    },
